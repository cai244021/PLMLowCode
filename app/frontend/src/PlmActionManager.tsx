    ...
    <section className="management-page">
      ...
      <div className="config-form" ref={formRef}>
        ...
        <div className="form-grid">
          ...
          <label><span>请求方式 <span className="required-mark" aria-hidden="true">*</span></span><select required value={draft.httpMethod} onChange={(e) => update('httpMethod', e.target.value as PlmActionDefinition['httpMethod'])}><option value="POST">POST</option><option value="GET">GET</option></select></label>
