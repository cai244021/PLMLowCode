...
<%!
	private static final Logger _logger =  LoggerFactory.getLogger("JF_ECRQQFileCheckinDialogFS");
%>
<%
	...
	String strAlertMess = ComponentsUtil.i18nStringNow("emxComponents.Common.ECRUploadFileIsRequire", strLang);
	String strObjectId = (String)emxGetParameter(request, "objectId");
	String flag = (String)emxGetParameter(request, "flag");
	_logger.info("--JF_PCR--objectId:{} {}",strObjectId,flag);
	//构造提交请求的url
	String AMP  = "&";
	StringBuilder url = new StringBuilder();
	url.append("./JF_PCRChangeFileCheckinProcess.jsp?");
	url.append("objectId=");
