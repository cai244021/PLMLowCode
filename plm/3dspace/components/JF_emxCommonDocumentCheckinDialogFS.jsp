...
<%
  ...
  if(emxCommonDocumentCheckinData == null)
  {
    ...
    String taskType = emxGetParameter(request,"taskType");
  ...
  String JF_ProjectDoc = (String) emxCommonDocumentCheckinData.get("JF_ProjectDoc");
...
<%
  ...
  boolean showPrev = (CommonDocument.OBJECT_ACTION_CREATE_MASTER.equalsIgnoreCase(objectAction) || 
      ...
      String flag = "";
      if (emxCommonDocumentCheckinData.containsKey("flag")){
          flag = (String) emxCommonDocumentCheckinData.get("flag");
      }
    	...
    	<head>
			...
			<script language="JavaScript" type="text/JavaScript">
                ...
                function checkinFile(button) {
                    // 获取表单元素
                    // var form = document.getElementsByName('checkinForm');

                    //把多选的文件分到checkinForm中的单选中
                    const fileInput = document.getElementsByClassName("fileMul");
		...
		<%}%>		
			...
			<div id='divPageBody'>
                <form>
                    <table class="list">
                        <tr>
                            <th class="required" width="100%" style="color: darkred;font-style: italic;">
