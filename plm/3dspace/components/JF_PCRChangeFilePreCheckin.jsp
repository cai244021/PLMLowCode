...
<body>
<%!
    private static final Logger _logger =  LoggerFactory.getLogger("JF_PCRChangeFilePreCheckin.jsp");
%>
<%
    String objectId = (String)emxGetParameter(request, "objectId");
    String flag = (String)emxGetParameter(request, "flag");
    _logger.info("Idm_IPPAPPreCheckin : objectId:{} flag {}",objectId,flag);
    StringBuffer sbUrl = new StringBuffer( "JF_PCRChangeFileCheckinDialogFS.jsp");
