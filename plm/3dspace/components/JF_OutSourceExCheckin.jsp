...
<body>
<%!
    private static final Logger _logger =  LoggerFactory.getLogger("JF_OutSourceExCheckin");
%>
<%
    String objectId = (String)emxGetParameter(request, "objectId");
    _logger.info("Idm_IPPAPPreCheckin : objectId:{}",objectId);
    StringBuffer sbUrl = new StringBuffer( "JF_OutSourceExCheckinDialogFS.jsp");
