...
<%
    ...
    StringBuffer sbUrl = new StringBuffer( "JF_RapidOfferExportProcess.jsp");
    sbUrl.append("?objectId=");
    sbUrl.append(objectId);
    String notesY = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.RapidOfferExport.Successful");
    String notesN = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.RapidOfferExport.Failed");
    String header = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Command.RapidOfferExport");
    ...
    String srcLink = "JF_RapidOfferExportFS.jsp?header=" + header + "&content=" + content;
%>
</body>
</html>
