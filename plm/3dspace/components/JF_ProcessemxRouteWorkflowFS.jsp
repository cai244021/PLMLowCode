...
<%@ page import="matrix.db.JPO" %><%-- emxRouteWorkflowFS.jsp --
...
<%!
  private static final Logger JF_LOGGER = LoggerFactory.getLogger("JF_ProcessemxRouteWorkflowFS.jsp");
%>
<%
...
/*  DomainObject obj = DomainObject.newInstance(context,objectId);
  ...
  objectId =ids.get(ids.size()-1);
   ...
   String routeObjectId = (String) JPO.invoke(context, "JF_ECRProcess", new String[0], "getLatestRoute", new String[]{objectId}, String.class);
