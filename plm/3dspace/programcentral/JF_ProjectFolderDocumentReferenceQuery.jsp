...
<%-- 20260811 update by ljr 项目文件夹功能JSP迁移至programcentral目录，公共资源统一使用../common相对路径。 --%>
...
<%
    ...
    if ("200".equals(code)) {
        ...
        tableUrl = new StringBuilder("../common/emxIndentedTable.jsp")
                ...
                .append("&suiteKey=ProgramCentral&SuiteDirectory=programCentral")
