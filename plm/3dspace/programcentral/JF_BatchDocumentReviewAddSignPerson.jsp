...
<%
    ...
    StringList existingPersonIds = batchReview.getInfoList(context, "from[JFDocument2SignPerson].to.id");
    ...
    try {
        ...
        batchReview.addRelatedObjects(context, new RelationshipType("JFDocument2SignPerson"), true, stringList.toStringArray());
