...
<%!
    private static final Logger LOGGER = LoggerFactory.getLogger("JF_ConfigTableRouteApprovalContent.jsp");
%>
<%
    ...
    try {
        ...
        StringList contentIds = new StringList();
        if (objectIds != null) {
        ...
        Map result = (Map) JPO.invoke(context, "JF_ProductConfig", null,
                "updateConfigTableRouteApprovalContent", JPO.packArgs(params), Map.class);
        code = (String) result.get("code");
        message = (String) result.get("mess");
    } catch (Exception e) {
        message = e.getMessage();
        LOGGER.error("JF_ConfigTableRouteApprovalContent error", e);
    }
