...
<%
    ...
    //放空
    if(Objects.isNull(tableRowIdList) || tableRowIdList.length == 0){
        return;
    }
    ...
    String strProjectIds = projectIdList.join(",");
    StringBuffer sbUrl = new StringBuffer( "JF_CostHistoryDownLoad.jsp");
    sbUrl.append("?objectId=");
    sbUrl.append(objectId);
    sbUrl.append("&");
    sbUrl.append("projectIds=");
    sbUrl.append(strProjectIds);
    String notesY = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Mess.ProjectCostSuccess");
    String notesN = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Mess.ProjectCostFailed");
    String header = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Mess.ProjectCostHerder");
