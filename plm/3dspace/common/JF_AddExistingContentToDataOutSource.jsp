...
<%
    ...
    String submitUrl = "&submitURL=../common/JF_postPrecessAddExistingWithRel.jsp?flag=" + flag;
    if ("JFDataOutSource".equalsIgnoreCase(flag)) {
        submitUrl = "&submitURL=../common/JF_postPrecessAddExistingWithRel.jsp?flag=" + flag;
    }
%>
<html>
<script>
    var searchUrl = "../common/emxFullSearch.jsp?field=TYPES=type_DOCUMENTS,type_VPMReference,type_Drawing,type_Document&showInitialResults=true&table=PMCGeneralSearchResults&selection=multiple";
    searchUrl += "&excludeOIDprogram=" + "<%=strProgram%>" + ":" + "<%=strFunction%>";
