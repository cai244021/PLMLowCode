...
<body>
<%
    StringBuffer sbUrl = new StringBuffer( "JF_ExportECRListDownload.jsp");
    String notesY = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Mess.ECRDownLoadHeaderSuccess");
    String notesN = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Mess.ECRDownLoadHeaderFailed");
    String header = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource", context.getLocale(), "emxComponents.Mess.ECRDownLoadHeader");
