...
<%!
    //??
    private static final Logger _logger =  LoggerFactory.getLogger("JF_PMCWBSTaskAssignSelectedPostProcess.jsp");
%>
<%
    String mess = "";
    String user = context.getUser();
    _logger.info("JF_PMCWBSTaskAssignSelectedPostProcess.jsp======user:{}", user);
    String strObjectId = emxGetParameter(request, "objectId");

    String[] tableRowId = emxGetParameterValues(request, "emxTableRowId");
    _logger.info("JF_PMCWBSTaskAssignSelectedPostProcess.jsp======tableRowId:{}", Arrays.asList(tableRowId));
