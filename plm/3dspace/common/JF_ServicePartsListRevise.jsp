...
<%!
    private static final Logger LOGGER = LoggerFactory.getLogger("JF_ServicePartsListRevise.jsp");
...
<%
    ...
    String failedMessage = EnoviaResourceBundle.getProperty(context,
            ...
            context.getLocale(),
            "emxFramework.JFServicePartsListRevision.Failed");
    try {
        ...
        if (objectIds == null || objectIds.length != 1 || UIUtil.isNullOrEmpty(objectIds[0])) {
            throw new Exception(EnoviaResourceBundle.getProperty(context,
                    "emxFrameworkStringResource",
                    context.getLocale(),
                    "emxFramework.JFServicePartsListRevision.SelectOne"));
        }
        ...
        LOGGER.error("JF_ServicePartsListRevise error", e);
    }
%>
<html>
<script>
