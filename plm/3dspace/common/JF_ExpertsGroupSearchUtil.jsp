...
<%
    ...
    for(int i=0;i<emxTableRowId.length;i++) {
        ...
        actualValue.append(strContextObjectPhysicalId);
...
<script language="javascript" type="text/javaScript">
    ...
    console.log("fieldNameDisplay--->"+"<xss:encodeForJavaScript><%=fieldNameDisplay%></xss:encodeForJavaScript>");
    console.log("displayValue--->"+"<xss:encodeForJavaScript><%=displayValue%></xss:encodeForJavaScript>");
