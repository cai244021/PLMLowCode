...
public class emxLifecycleBase_mxJPO
{
    ...
    private static final String SELECT_ATTRIBUTE_TEMPLATE_TASK = "attribute[" + DomainObject.ATTRIBUTE_TEMPLATE_TASK + "]";
    ...
    private static final String SELECT_ROUTE_TASK_ASSIGNEE_TITLE = "from[" + DomainObject.RELATIONSHIP_PROJECT_TASK + "].to."+DomainConstants.SELECT_ATTRIBUTE_TITLE;
    ...
    private static final String SELECT_REL_ATTRIBUTE_TEMPLATE_TASK = DomainRelationship.getAttributeSelect(DomainObject.ATTRIBUTE_TEMPLATE_TASK);
    ...
    public  MapList getCurrentTaskSignaturesOnObject(Context context, String[] args) throws Exception {
        try {
            ...
            for (Iterator itrAllObjects = mlAllObjectsInfo.iterator(); itrAllObjects.hasNext();) {
                ...
                strRelWhere = ATTRIBUTE_OPEN_BRACE + DomainObject.ATTRIBUTE_ROUTE_BASE_POLICY + "]=='" + strSymbolicPolicyName + "' && attribute[" + DomainObject.ATTRIBUTE_ROUTE_BASE_STATE + "]=='" + strObjectSymbolicStateName + "'";
                strObjectWhere="(islast == TRUE)";
                ...
                for (Iterator itrRoutes = mlRoutes.iterator(); itrRoutes.hasNext();) {
                    ...
                    strTypePattern = DomainObject.TYPE_PERSON + "," + DomainObject.TYPE_ROUTE_TASK_USER + "," + proxyGroupType;
                    slBusSelect = new StringList();
                    slBusSelect.add(DomainObject.SELECT_ID);
                    slBusSelect.add(DomainObject.SELECT_TYPE);
                    slBusSelect.add(DomainObject.SELECT_NAME);
                    slBusSelect.add(DomainObject.SELECT_ATTRIBUTE_TITLE);
                    slRelSelect = new StringList();
                    ...
                    slBusSelect.add(SELECT_ROUTE_TASK_ASSIGNEE_TITLE);
                    ...
                    for (Iterator itrActiveTasks = mlActivatedTasksOnRoute.iterator(); itrActiveTasks.hasNext();) {
                        ...
                        if(proxyGroupType.equalsIgnoreCase((String)mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TYPE)) || groupType.equalsIgnoreCase((String)mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TYPE))){
                        	mapTemp2.put("assigneeName", mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TITLE));
                        	mapTemp2.put("assigneeUserGroupName", mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_NAME));
                        }else {
                        ...
                        mapTemp2.put("emxFlatTableRowId", strObjectId + "^" + (String)mapTemp.get(DomainObject.SELECT_CURRENT) + "^^" + (String)mapTemp.get(DomainObject.SELECT_ID)+"^"+DomainObject.TYPE_INBOX_TASK);
                    ...
                    for (Iterator itrDefinedTasks = mlDefinedTasksOnRoute.iterator(); itrDefinedTasks.hasNext();) {
                        ...
                        if(proxyGroupType.equalsIgnoreCase((String)mapTemp.get(DomainObject.SELECT_TYPE)) || groupType.equalsIgnoreCase((String)mapTemp.get((DomainObject.SELECT_TYPE)))){
                        	mapTemp2.put("assigneeName", mapTemp.get(DomainObject.SELECT_ATTRIBUTE_TITLE));
                        	mapTemp2.put("assigneeUserGroupName", mapTemp.get(DomainObject.SELECT_NAME));
                        }else {
                        ...
                        mapTemp2.put("emxFlatTableRowId", strObjectId + "^" + (String)mapTemp.get(DomainObject.SELECT_CURRENT) + "^^" + (String)mapTemp.get(DomainObject.SELECT_ID)+"^"+DomainObject.RELATIONSHIP_ROUTE_NODE);
                        // Set parent object information
                        mapTemp2.put("parentObjectId", mapObjectInfo.get(DomainObject.SELECT_ID));
                        mapTemp2.put("parentObjectName", mapObjectInfo.get(DomainObject.SELECT_NAME));
                        mapTemp2.put("parentObjectType", mapObjectInfo.get(DomainObject.SELECT_TYPE));
                ...
                if (fromState != null) {
                    ...
                    for (Iterator itrSignatureDetails = mlSignatureDetails.iterator(); itrSignatureDetails.hasNext();) {
						...
						mapSignatureInfo.put("objectPolicy", mapObjectInfo.get(DomainObject.SELECT_POLICY));
                        ...
                        mapSignatureInfo.put("emxFlatTableRowId", strObjectId + "^" + (String)mapObjectInfo.get(DomainObject.SELECT_CURRENT) + "^" + strSignatureName + "^^");
    ...
    private MapList getCurrentAssignedTaskSignaturesOnObject(Context context, String objectId) throws Exception {
        ...
        try {
            ...
            final String SELECT_ATTRIBUTE_CURRENT_ROUTE_NODE = ATTRIBUTE_OPEN_BRACE + PropertyUtil.getSchemaProperty(context, "attribute_CurrentRouteNode") + "]";
...
// IR-043921V6R2011 - Changes END
                ...
                for (Iterator itrRoutes = mlRoutes.iterator(); itrRoutes.hasNext();) {
                    ...
                    for (Iterator itrActiveTasks = mlActivatedTasksOnRoute.iterator(); itrActiveTasks.hasNext();) {
                        ...
                        }else if (groupType.equals((String)mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TYPE)) || proxyGoupType.equals((String)mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TYPE))) {
                        	String mqlResult = MqlUtil.mqlCommand(context, "print person $1 select $2 dump $3", strContextUser, "isassigned["+(String)mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_NAME)+"]", "|");
    ...
    public  MapList getAllAssignedTasks(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            final String SELECT_ATTRIBUTE_DUE_DATE = ATTRIBUTE_OPEN_BRACE + ATTRIBUTE_DUE_DATE + "]";


            DomainObject dmoPerson     = PersonUtil.getPersonObject(context);
            StringList selectTypeStmts = new StringList();
            StringList selectRelStmts  = new StringList();
            selectTypeStmts.add(SELECT_ATTRIBUTE_COMMENTS);
            ...
            String objectWhere = "(type=='" + DomainObject.TYPE_TASK + "' && current=='" + POLICY_PROJECT_TASK_STATE_REVIEW + "') || " +
                                 "(type=='" + DomainObject.TYPE_INBOX_TASK + "' && current!='" + POLICY_INBOX_TASK_STATE_COMPLETE + "' && current!='" + POLICY_INBOX_TASK_STATE_REVIEW + "')&&" + "(from["+DomainConstants.RELATIONSHIP_ROUTE_TASK+"].to.attribute["+DomainConstants.ATTRIBUTE_ROUTE_STATUS+"].value!=Stopped)" ;
            ...
            Map<String,String> rolesMap = PersonUtil.getAssignmentsMap(context, context.getUser(), vecPersonAssignments);
            ...
            Group groupObj = null;
            Role roleObj = null;
            List vecParentRolesOrGroups = null;
            ...
            for (Iterator itrPersonAssignments = slPersonAssignments.iterator(); itrPersonAssignments.hasNext();) {
                ...
                isRoleGroupOrUserGroup = rolesMap.get(strRoleOrGroup);
                // Is it role?
                try {
                	if("projectgroup".equals(isRoleGroupOrUserGroup)){
                		userGroupList.add(strRoleOrGroup);
            ...
            if(!userGroupList.isEmpty()){
         	   ...
         	   String strUserGroupList = FrameworkUtil.join(userGroupList,",");
         	  objectWhere = objectWhere + "from[" + DomainConstants.RELATIONSHIP_PROJECT_TASK+ "].to.name" + " matchlist " + "\"" + strUserGroupList + "\" \",\"";
            }
    ...
    public  MapList getAllTaskSignaturesOnObject(Context context, String[] args) throws Exception {
        try {
        	String ATTRIBUTE_INITIAL_TASK = DomainRelationship.getAttributeSelect(PropertyUtil.getSchemaProperty(context,"attribute_InitialTask"));
            // To hold the table data
            MapList mlTableData = new MapList();
            ...
            StringList slPersonAssignments = new StringList();
            StringList slParentRolesOrGroups = new StringList();
            StringList assignedUserGroup = new StringList();
            ...
            for (Iterator itrPersonAssignments = slPersonAssignments.iterator(); itrPersonAssignments.hasNext();) {
                ...
                try {
                	if("projectgroup".equals(isRoleGroupOrUserGroup)){
                		assignedUserGroup.add(strRoleOrGroup);
                	}else if("role".equals(isRoleGroupOrUserGroup)){
                        roleObj = new Role(strRoleOrGroup);
                        roleObj.open(context);
                        // Find all its parents
            ...
            slBusSelect.add(DomainObject.SELECT_ID);
            slBusSelect.add(SELECT_ATTRIBUTE_ROUTE_STATUS);
            slBusSelect.add("from[" + DomainObject.RELATIONSHIP_INITIATING_ROUTE_TEMPLATE + "].to.attribute["+DomainObject.ATTRIBUTE_TASKEDIT_SETTING+"]");
            slBusSelect.add("attribute["+DomainObject.ATTRIBUTE_TASKEDIT_SETTING+"]");
            strRelWhere = "";
            strObjectWhere = "(islast == TRUE)";
            mlRoutes = dmoObject.getRelatedObjects(context, strRelPattern, strTypePattern, slBusSelect, slRelSelect, !GET_TO, GET_FROM, nRecurseToLevel, strObjectWhere, strRelWhere);
            ...
            for (int nStateIndex = 0; nStateIndex < nTotalStates; nStateIndex++) {
                ...
                for (Iterator itrRoutes = mlRoutes.iterator(); itrRoutes.hasNext();) {
                    ...
                    String sTaskEditSetting = (String)mapRouteInfo.get("from[" + DomainObject.RELATIONSHIP_INITIATING_ROUTE_TEMPLATE + "].to.attribute["+DomainObject.ATTRIBUTE_TASKEDIT_SETTING+"]");
                    String sRouteEditSetting = (String)mapRouteInfo.get("attribute["+DomainObject.ATTRIBUTE_TASKEDIT_SETTING+"]");
                    ...
                    slRelSelect.add(SELECT_REL_ATTRIBUTE_COMMENTS);
                    slRelSelect.add(SELECT_REL_ATTRIBUTE_ROUTE_TASK_USER);
                    slRelSelect.add(SELECT_REL_ATTRIBUTE_TEMPLATE_TASK);
                    slRelSelect.add(SELECT_ATTRIBUTE_ROUTE_ACTION);
                    slRelSelect.add(ATTRIBUTE_INITIAL_TASK);
					//added to get route node as name
					slRelSelect.add(DomainObject.SELECT_NAME);
					slRelSelect.add(DomainObject.SELECT_TO_NAME);
                    ...
                    slBusSelect.add(SELECT_ATTRIBUTE_ROUTE_TASK_USER);
                    slBusSelect.add(SELECT_ATTRIBUTE_ROUTE_ACTION);
 					slBusSelect.add(SELECT_ATTRIBUTE_TEMPLATE_TASK);
 					slBusSelect.add(ATTRIBUTE_INITIAL_TASK);
                    ...
                    for (Iterator itrActiveTasks = mlActivatedTasksOnRoute.iterator(); itrActiveTasks.hasNext();) {
                        ...
                        mapTemp2.put("assigneeId", mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_ID));
                        mapTemp2.put("assigneeType", mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TYPE));
                        if(proxyGoupType.equalsIgnoreCase((String)mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TYPE)) || groupType.equalsIgnoreCase((String)mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TYPE))){
                        	mapTemp2.put("assigneeName", mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_TITLE));
                        	mapTemp2.put("assigneeUserGroupName", mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_NAME));
                        }else {
                        mapTemp2.put("assigneeName", mapTemp.get(SELECT_ROUTE_TASK_ASSIGNEE_NAME));
                        ...
                        mapTemp2.put("routeTaskUser", mapTemp.get(SELECT_ATTRIBUTE_ROUTE_TASK_USER));
                        mapTemp2.put("owner", mapTemp.get(DomainObject.SELECT_OWNER));
                        mapTemp2.put("id", strObjectId + "^" + strCurrentStateName + "^^" + mapTemp.get(DomainObject.SELECT_ID)+"^"+DomainObject.TYPE_INBOX_TASK);
                        mapTemp2.put("currentRowState", strCurrentStateName);
                        mapTemp2.put("routeAction", mapTemp.get(SELECT_ATTRIBUTE_ROUTE_ACTION));
						mapTemp2.put("owner", mapTemp.get(DomainConstants.SELECT_OWNER));
						mapTemp2.put("templateTask", mapTemp.get(SELECT_ATTRIBUTE_TEMPLATE_TASK));
						mapTemp2.put("sTaskEditSetting",sTaskEditSetting);
						mapTemp2.put("initialTask", mapTemp.get(ATTRIBUTE_INITIAL_TASK));
						mapTemp2.put("sRouteEditSetting",sRouteEditSetting);
                        // Object information
                	...
                	if(mlTableData.size() > 1){
                		Collections.sort(mlTableData, mapComparator);
                	}
                    ...
                    for (Iterator itrDefinedTasks = mlDefinedTasksOnRoute.iterator(); itrDefinedTasks.hasNext();) {
                        ...
                        mapTemp2.put("assigneeId", mapTemp.get(DomainObject.SELECT_ID));
                        mapTemp2.put("assigneeType", mapTemp.get(DomainObject.SELECT_TYPE));
                        if(proxyGoupType.equalsIgnoreCase((String)mapTemp.get(DomainObject.SELECT_TYPE)) || groupType.equalsIgnoreCase((String)mapTemp.get(DomainObject.SELECT_TYPE))){
                        	mapTemp2.put("assigneeName", mapTemp.get(DomainObject.SELECT_ATTRIBUTE_TITLE));
                        	mapTemp2.put("assigneeUserGroupName", mapTemp.get(DomainObject.SELECT_TO_NAME));
                        }else {
                        	mapTemp2.put("assigneeName", mapTemp.get(DomainObject.SELECT_TO_NAME));
                        }
                        mapTemp2.put("routeTaskUser", mapTemp.get(SELECT_REL_ATTRIBUTE_ROUTE_TASK_USER));
                        mapTemp2.put("id", strObjectId + "^" + strCurrentStateName + "^^" + mapTemp.get(SELECT_REL_ATTRIBUTE_ROUTE_NODE_ID)+"^"+DomainObject.RELATIONSHIP_ROUTE_NODE);
                        mapTemp2.put("currentRowState", strCurrentStateName);
                        mapTemp2.put("routeAction", mapTemp.get(SELECT_ATTRIBUTE_ROUTE_ACTION));
                        mapTemp2.put("templateTask", mapTemp.get(SELECT_REL_ATTRIBUTE_TEMPLATE_TASK));
                        mapTemp2.put("initialTask", mapTemp.get(ATTRIBUTE_INITIAL_TASK));
                        // Object information
                        mapTemp2.put("parentObjectId", strObjectId);
                        mapTemp2.put("parentObjectState", strCurrentStateName);
            ...
            for (Iterator itrRoutes = mlRoutes.iterator(); itrRoutes.hasNext();) {
                ...
                for (Iterator itrActiveTasks = mlActivatedTasksOnRoute.iterator(); itrActiveTasks.hasNext();) {
                    ...
                    mapTemp2.put("parentObjectPolicy", strObjectPolicyName);
                    mapTemp2.put("owner", mapTemp.get(DomainConstants.SELECT_OWNER));
                    mapTemp2.put("id", strObjectId + "^^^" + mapTemp.get(DomainObject.SELECT_ID)+"^"+DomainObject.TYPE_INBOX_TASK);
                    // Level Required for sorting
                    mapTemp2.put("level", "1");
                ...
                for (Iterator itrDefinedTasks = mlDefinedTasksOnRoute.iterator(); itrDefinedTasks.hasNext();) {
                    ...
                    mapTemp2.put("id", strObjectId + "^^^" + mapTemp.get(SELECT_REL_ATTRIBUTE_ROUTE_NODE_ID)+"^"+DomainObject.RELATIONSHIP_ROUTE_NODE);
                    mapTemp2.put("owner", mapTemp.get(DomainConstants.SELECT_OWNER));
                    // Level Required for sorting
                    mapTemp2.put("level", "1");
					mapTemp2.put("sTaskEditSetting",sTaskEditSetting);
    ...
    public  int completeTaskOrSignature(Context context, String[] args) throws Exception {
        try {
            ...
            if (strSignatureName != null && !"".equals(strSignatureName)) {
                ...
                String strMqlCmd = "$1 bus $2 signature $3 comment $4";
                mqlCommand.executeCommand(context, strMqlCmd, strApprovalAction, strObjectId, strSignatureName, strSignComments);           
                ...
                if ("approve".equals(strApprovalAction) || "abstain".equals(strApprovalAction)) {//Modified for bug 346480
                    ...
                    busSelects.add(Route.SELECT_ATTRIBUTE_OBJECT_ROUTE_MODELER_TYPE_WITH_TASK);
                    ...
                    if (DomainObject.TYPE_INBOX_TASK.equals(strObjType)) {
                        strAlertMessage = userTask.doInboxTaskAction(context, taskId, appMap, strSignComments, "Complete", iClientTimeOffset,strApprovalAction);
    ...
    public  int reassignTask(Context context, String[] args) throws Exception {
        try {
            ...
            String groupType = PropertyUtil.getSchemaProperty(context,"type_Group");
            String proxyGoupType = PropertyUtil.getSchemaProperty(context,"type_GroupProxy");
            String assigneeName = strNewAssignee;
			boolean isGroupRoleIncluded = false;
			String strOldAssigneeType = "";
			String strOldAssigneeName = "";
            if ("Person".equals(strNewAssigneeType)) {
                strNewAssignee = PersonUtil.getPersonObjectID(context, strNewAssignee);
            }else if(FrameworkUtil.isUserGroupObject(context, strNewAssignee)){
            	strNewAssigneeType = "User Group";
			}else{
				isGroupRoleIncluded = true;
            }
			...
			String SELECT_ROUTE_PHYSICAL_ID                      =   "from[" + DomainObject.RELATIONSHIP_ROUTE_TASK + "].to.physicalid";
            String SELECT_RELATIONSHIP_PROJECT_TASK_ID  =   "from[" + DomainObject.RELATIONSHIP_PROJECT_TASK + "].id";
            String SELECT_ATTRIBUTE_ROUTE_NODE_ID       =   ATTRIBUTE_OPEN_BRACE + DomainObject.ATTRIBUTE_ROUTE_NODE_ID + "]";
            ...
            String SELECT_ATTRIBUTE_ROUTE_TASK_USER     =   ATTRIBUTE_OPEN_BRACE +DomainObject.ATTRIBUTE_ROUTE_TASK_USER+"]";
			...
			StringList newAssigneeList = new StringList();
			StringList oldAssigneeList = new StringList();
            ...
            else
            {
                ...
                MQLCommand mqlCommand = new MQLCommand();
                String strMqlCmd = "print bus $1 select exists";
                mqlCommand.open(context);
                mqlCommand.executeCommand(context, strMqlCmd, strTaskId);
				...
				if (strExists.indexOf("FALSE") >= 0)
                {
					...
					strOldAssigneeType   = (String)((Map)resultMapList.get(0)).get(SELECT_REL_ROUTE_TASK_ASSIGNEE_TYPE);
                    String tmpOldAssigneeName   = (String)((Map)resultMapList.get(0)).get(SELECT_ATTRIBUTE_ROUTE_TASK_USER);
					strOldAssigneeName   =  PropertyUtil.getSchemaProperty(context, tmpOldAssigneeName);

                    if("Person".equals(strOldAssigneeType) || groupType.equals(strOldAssigneeType) || proxyGoupType.equals(strOldAssigneeType))
                    {
                        if("Person".equals(strNewAssigneeType) || "User Group".equals(strNewAssigneeType))
                        {
                    ...
                    {
                        if("Person".equals(strNewAssigneeType) || groupType.equals(strOldAssigneeType) || proxyGoupType.equals(strOldAssigneeType))
                        {
                ...
                else
                {
                    ...
                    if("Person".equals(strNewAssigneeType) || groupType.equals(strNewAssigneeType) || proxyGoupType.equals(strNewAssigneeType))
                    {
						...
						taskSelectList.add(SELECT_ROUTE_PHYSICAL_ID);
						...
						strOldAssigneeType   = (String)taskMap.get(SELECT_TASK_ASSIGNEE_TYPE);
                        String sRouteId             = (String)taskMap.get(SELECT_ROUTE_ID);
						String sRoutePhysicalId             = (String)taskMap.get(SELECT_ROUTE_PHYSICAL_ID);
                        ...
                        if("Person".equals(strOldAssigneeType ) || groupType.equals(strOldAssigneeType) || proxyGoupType.equals(strOldAssigneeType))
                        {
                            ...
                            if(!sTaskOldAssigneeId.equals(strNewAssignee)) {
                                ...
                                if ("true".equalsIgnoreCase(strAllowDelegation) && !( groupType.equals(strNewAssigneeType) || proxyGoupType.equals(strNewAssigneeType))) {
                                    ...
                                    final String SELECT_ATTRIBUTE_ABSENCE_DELEGATE = ATTRIBUTE_OPEN_BRACE + ATTRIBUTE_ABSENCE_DELEGATE + "]";
                                    final String SELECT_ATTRIBUTE_ABSENCE_END_DATE = ATTRIBUTE_OPEN_BRACE + ATTRIBUTE_ABSENCE_END_DATE + "]";
                                    final String SELECT_ATTRIBUTE_ABSENCE_START_DATE = ATTRIBUTE_OPEN_BRACE + ATTRIBUTE_ABSENCE_START_DATE + "]";
								...
								strOldAssigneeName = strOldTaskAssigneeName;
                                String strNewTaskAssigneeName = (String)((Map)mapInfo.get(strNewAssignee)).get(Person.SELECT_NAME);
								strNewAssignee = strNewTaskAssigneeName;
                                if(groupType.equals(strNewAssigneeType) || proxyGoupType.equals(strNewAssigneeType)){
									strNewAssigneeType = "User Group";
                                	 taskObject.setOwner(context,ROLE_USER_GROUP);
                                	 MapList mlMembers = FrameworkUtil.getProjectGroupAssignees(context, strNewTaskAssigneeName);
                                	 if( mlMembers.size() > 0 ) {
                                		 Map mTemp = null;
                                		 for( Iterator itr = mlMembers.iterator(); itr.hasNext(); ) {
                                			 mTemp = (Map) itr.next();
                                			 toList.add( (String) mTemp.get( DomainConstants.SELECT_NAME ));
											newAssigneeList.add( (String) mTemp.get( DomainConstants.SELECT_NAME ));
                                		 }
                                		 }
									String tempValues = MqlUtil.mqlCommand(context,"temp query bus $1 $2 $3 select $4 dump $5", PropertyUtil.getSchemaProperty(context, "type_GroupProxy"), strNewTaskAssigneeName, "-", DomainConstants.SELECT_ATTRIBUTE_TITLE , "~");
									String strNewTaskAssigneeNameTemp = tempValues.split("~")[3];
									if(UIUtil.isNotNullAndNotEmpty(strNewTaskAssigneeNameTemp)){
										strNewAssignee = strNewTaskAssigneeNameTemp;
                                	 }
                                }else {
                                taskObject.setOwner(context,strNewTaskAssigneeName);
                                toList.add(strNewTaskAssigneeName);
									newAssigneeList.add(strNewTaskAssigneeName);
                                }
                                ...
                                {
                                	if(groupType.equals(strOldAssigneeType) || proxyGoupType.equals(strOldAssigneeType)){
										strOldAssigneeType = "User Group";
                                		 MapList mlMembers = FrameworkUtil.getProjectGroupAssignees(context, strOldTaskAssigneeName);
										String tempValues = MqlUtil.mqlCommand(context,"temp query bus $1 $2 $3 select $4 dump $5", PropertyUtil.getSchemaProperty(context, "type_GroupProxy"), strOldTaskAssigneeName, "-", DomainConstants.SELECT_ATTRIBUTE_TITLE , "~");
										String strOldTaskAssigneeNameTemp = tempValues.split("~")[3];
										if(UIUtil.isNotNullAndNotEmpty(strOldTaskAssigneeNameTemp)){
											strOldAssigneeName = strOldTaskAssigneeNameTemp;
										}
                                    	 if( mlMembers.size() > 0 ) {
                                    		 Map mTemp = null;
                                    		 for( Iterator itr = mlMembers.iterator(); itr.hasNext(); ) {
                                    			 mTemp = (Map) itr.next();
                                    			 ccList.add( (String) mTemp.get( DomainConstants.SELECT_NAME ));
												oldAssigneeList.add((String) mTemp.get( DomainConstants.SELECT_NAME ));
                                    		 }
                                    	 }
                                	}else {
                                    ccList.add(strOldTaskAssigneeName);
										oldAssigneeList.add(strOldTaskAssigneeName);
                                	}
                                ...
                                {
                                	if(!toList.contains(strOldTaskAssigneeName)){
                                    toList.add(strOldTaskAssigneeName);
                                	}
                                	if(!ccList.contains(strRouteOwner)){
                                    ccList.add(strRouteOwner);
                                	}
                                }
                            }
                ...
                if(toList.size() >= 1 && ccList.size() >= 1) {
					...
					MailUtil.sendMessage(context, toList, ccList, null, strSubject, strBody + strComments, new StringList(strTaskId),"true".equalsIgnoreCase(mailEnabled));
						 String SELECT_ROUTE_OWNER                      =   "from[" + DomainObject.RELATIONSHIP_ROUTE_TASK + "].to.owner";
						 String SELECT_ROUTE_NAME                     =   "from[" + DomainObject.RELATIONSHIP_ROUTE_TASK + "].to.name";
						 String SELECT_ROUTE_TITLE                     =   "from[" + DomainObject.RELATIONSHIP_ROUTE_TASK + "].to.attribute[Title]";
						 StringList taskSelectList = new StringList(5);
	                     taskSelectList.add(SELECT_TASK_ASSIGNEE_TYPE);
	                     taskSelectList.add(DomainConstants.SELECT_NAME);
	                     taskSelectList.add(SELECT_ATTRIBUTE_SCHEDULED_COMPLETION_DATE);
	                     taskSelectList.add(SELECT_ATTRIBUTE_ROUTE_INSTRUCTIONS);
	                     taskSelectList.add(SELECT_REL_ROUTE_TASK_ASSIGNEE_ID);
	                     taskSelectList.add(SELECT_ROUTE_ID);
	                     taskSelectList.add(SELECT_ROUTE_OWNER);
	                     taskSelectList.add(SELECT_ROUTE_NAME);
	                     taskSelectList.add(SELECT_ROUTE_TITLE);
					taskSelectList.add(DomainConstants.SELECT_PHYSICAL_ID);
	                     taskSelectList.add(SELECT_ATTRIBUTE_ROUTE_ACTION);
					taskSelectList.add(SELECT_ROUTE_PHYSICAL_ID);
					taskSelectList.add(InboxTask.SELECT_TITLE);

	                     InboxTask inboxTaskObj = (InboxTask)DomainObject.newInstance(context,DomainConstants.TYPE_INBOX_TASK);
                         inboxTaskObj.setId(strTaskId);
	                     Map taskMap = inboxTaskObj.getInfo(context,taskSelectList);
					Route object = new Route((String)taskMap.get(SELECT_ROUTE_ID));
					StringList objectSelects = new StringList();
					objectSelects.add(DomainConstants.SELECT_ID);
					objectSelects.add(DomainConstants.SELECT_NAME);
					objectSelects.add(DomainConstants.SELECT_ATTRIBUTE_TITLE);
					objectSelects.add(DomainConstants.SELECT_TYPE);
					MapList items = object.getRelatedObjects(
					...
					items.addSortKey(DomainConstants.SELECT_NAME, DomainConstants.SortDirection.ASCENDING.toString(), String.class.getSimpleName());
					items.sort();
					StringBuffer sRouteContentNotif = new StringBuffer(); 
					StringBuffer sRouteContentIdsNotif = new StringBuffer(); 
					StringBuffer sRouteContentTypesNotif = new StringBuffer(); 
					StringBuffer sRouteContentTitlesNotif = new StringBuffer(); 
					for(int i = 0; i < items.size(); i++) {
						// Map of the Objects
						Map routeContent = (Map) items.get(i);
						if (i > 0) {
							sRouteContentNotif.append(", ");
							sRouteContentIdsNotif.append(", ");
							sRouteContentTypesNotif.append(", ");
							sRouteContentTitlesNotif.append(", ");
						}
						sRouteContentNotif.append((String) routeContent.get(DomainConstants.SELECT_NAME));
						sRouteContentTitlesNotif.append((String) routeContent.get(DomainConstants.SELECT_ATTRIBUTE_TITLE));
						sRouteContentTypesNotif.append((String) routeContent.get(DomainConstants.SELECT_TYPE));
						sRouteContentIdsNotif.append((String) routeContent.get(DomainConstants.SELECT_ID));
					}
					if(!isGroupRoleIncluded) {
						String taskTitle = (String)taskMap.get(InboxTask.SELECT_TITLE);
						...
						taskAndRouteInfo.put(RouteTaskNotification.ROUTE_ID, (String) taskMap.get(SELECT_ROUTE_PHYSICAL_ID));
						taskAndRouteInfo.put(RouteTaskNotification.ROUTE_NAME, (String) taskMap.get(SELECT_ROUTE_TITLE));
						taskAndRouteInfo.put(RouteTaskNotification.ROUTE_OWNER, (String) taskMap.get(SELECT_ROUTE_OWNER));
			            taskAndRouteInfo.put(RouteTaskNotification.TASK_ID, (String) taskMap.get(DomainConstants.SELECT_PHYSICAL_ID));
			            taskAndRouteInfo.put(RouteTaskNotification.TASK_ACTION, (String) taskMap.get(SELECT_ATTRIBUTE_ROUTE_ACTION));
			            taskAndRouteInfo.put(RouteTaskNotification.TASK_INSTRUCTION, (String) taskMap.get(SELECT_ATTRIBUTE_ROUTE_INSTRUCTIONS));
			            taskAndRouteInfo.put(RouteTaskNotification.DUE_DATE, (String) taskMap.get(SELECT_ATTRIBUTE_SCHEDULED_COMPLETION_DATE));
			            taskAndRouteInfo.put(RouteTaskNotification.ROUTE_CONTENT_IDS, sRouteContentIdsNotif.toString());
			            taskAndRouteInfo.put(RouteTaskNotification.ROUTE_CONTENT_TYPES, sRouteContentTypesNotif.toString());
			            taskAndRouteInfo.put(RouteTaskNotification.ROUTE_CONTENT_TITLES, sRouteContentTitlesNotif.toString());
		                ...
		                taskAndRouteInfo.put(RouteTaskNotification.TASK_ASSIGNEE, strNewAssignee);
		                taskAndRouteInfo.put(RouteTaskNotification.ASSIGNEE_TYPE, strNewAssigneeType);
		                taskAndRouteInfo.put(RouteTaskNotification.OLD_ASSIGNEE_NAME, strOldAssigneeName);
		                taskAndRouteInfo.put(RouteTaskNotification.OLD_ASSIGNEE_TYPE, strOldAssigneeType);
		                
		                String modelerType = (String)taskMap.get(Route.SELECT_ATTRIBUTE_OBJECT_ROUTE_MODELER_TYPE_WITH_TASK);
			            RouteTaskNotification notifyObj = RouteTaskNotification.getInstance(context, sRouteContentTypesNotif.toString(),modelerType);
			            notifyObj.sendTaskReassignment3DNotification(context, taskAndRouteInfo, newAssigneeList, oldAssigneeList);
	                     }
                }
            }
    ...
    public int addApproverTask(Context context, String[] args) throws Exception {
         try {
            ...
            String rid= "";
            String chooseUsersFromUserGroup= "";
            String routeOwnerTask= "FALSE";
            String routeOwnerUGChoice= "";
            if(args.length >13 ) {
            	rid = args[13];
            }
            if(args.length >=15 ) {
            	chooseUsersFromUserGroup = args[14];
            }
            if(args.length >=16 ) {
            	routeOwnerTask = args[15];
            }
            if(args.length >=17 ) {
            	routeOwnerUGChoice = args[16];
            }
            if ("true".equalsIgnoreCase(strAllowDelegation)) {
            ...
            final String ATT_CHOOSE_USERS_FROM_UG  = PropertyUtil.getSchemaProperty(context, "attribute_ChooseUsersFromUserGroup");
            final String ATT_ROUTE_OWNER_TASK = PropertyUtil.getSchemaProperty(context, "attribute_RouteOwnerTask");
            final String ATT_ROUTE_OWNER_UG_CHOICE = PropertyUtil.getSchemaProperty(context, "attribute_RouteOwnerUGChoice");
            // Get object information
            StringList slBusSelect = new StringList();
            slBusSelect.add(DomainObject.SELECT_POLICY);
            slBusSelect.add(DomainObject.SELECT_CURRENT);
            ...
            slBusSelect.add("attribute[" + DomainConstants.ATTRIBUTE_TASKEDIT_SETTING + "]");
            ...
            String strObjectWhere = "current != Complete && current != Archive";
            ...
            {
            	strObjectWhere = "id=="+ rid +"||physicalid=="+rid;
            }
            ...
            if (mlRoutes.size() == 0) {
               ...
               //////////////////////////////////////////////////////////////////////////////////////
                for (Iterator itrActiveTasks = mlRoutes.iterator(); itrActiveTasks.hasNext();) {
                    ...
                    String routeTaskEditSetting = (String)mapTemp.get("attribute[" + DomainConstants.ATTRIBUTE_TASKEDIT_SETTING + "]");
                    ...
                    // if route state is in process and RTE is "Maintain Exact Task List", need to block the addition
                    String state = (String)mapTemp.get(DomainConstants.SELECT_CURRENT);
                    if(UIUtil.isNullOrEmpty(intiatingRouteTaskEditSetting) && "Maintain Exact Task List".equals(routeTaskEditSetting) && DomainConstants.STATE_ROUTE_IN_PROCESS.equalsIgnoreCase(state)) {
                    	String taskAddApproverAlert = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource",  context.getLocale(), "emxComponents.Route.MaintainExactTaskListTaskAddAlert");
                    	throw new MatrixException(taskAddApproverAlert);
                    }
            ...
            if("Person".equals(StrApproverType) || "UserGroup".equals(StrApproverType)){
                //Adding Person to the route
            	if("UserGroup".equals(StrApproverType)){
            		StringBuffer sbWhere         = new StringBuffer(150);
                    sbWhere.append("(");
                    sbWhere.append(DomainConstants.SELECT_ATTRIBUTE_TITLE);
                    sbWhere.append("==");
                    sbWhere.append("'");
                    sbWhere.append(strApprover);
                    sbWhere.append("'");
                    sbWhere.append(")");
                    String strWhereExpression = sbWhere.toString();
            	    String typeGroupProxy = PropertyUtil.getSchemaProperty(context,"type_GroupProxy");
            		String mqlCommand = "temp query bus $1 $2 $3 where $4 select $5 dump $6";
            		String tempId = MqlUtil.mqlCommand(context, mqlCommand, typeGroupProxy, "*","-",strWhereExpression,DomainConstants.SELECT_ID,"|");
            		strPersonObjId = FrameworkUtil.split(tempId, "|").get(3);
            		
            		if(UIUtil.isNullOrEmpty(strPersonObjId)) {
            			 sbWhere         = new StringBuffer(150);
            			 sbWhere.append("(");
                         ...
                         strWhereExpression = sbWhere.toString();
                 		 tempId = MqlUtil.mqlCommand(context, mqlCommand, typeGroupProxy, "*","-",strWhereExpression,DomainConstants.SELECT_ID,"|");
                 		 strPersonObjId = FrameworkUtil.split(tempId, "|").get(3);
            		}
            	}else {
            ...
            if("true".equalsIgnoreCase(chooseUsersFromUserGroup)) {
            	mapRelRouteNodeAttributes.put(ATT_CHOOSE_USERS_FROM_UG, "True");
            }
            if("true".equalsIgnoreCase(routeOwnerTask)) {
            	mapRelRouteNodeAttributes.put(ATT_ROUTE_OWNER_TASK, "TRUE");
            }
            
            if(UIUtil.isNotNullAndNotEmpty(routeOwnerUGChoice)) {
            	mapRelRouteNodeAttributes.put(ATT_ROUTE_OWNER_UG_CHOICE, routeOwnerUGChoice);
            }
            if ("assigneeSetDueDateSet".equals(strDueDateOption)) {
				...
				String strDueDateToSet = "";
				if(strDueDate.indexOf('/') >= 0){
					strDueDateToSet = strDueDate;
				}else{
					SimpleDateFormat dateFormat = new SimpleDateFormat (eMatrixDateFormat.getInputDateFormat(), Locale.US);
					strDueDateToSet = dateFormat.format(new Date(Long.parseLong(strDueDate)));
				}
			...
			// Added for IR-669703-3DEXPERIENCER2016x - Any All field to be set based on current route order value. //
            String strRelPatternRouteNode = DomainObject.RELATIONSHIP_ROUTE_NODE;
            String strTypePatternRoute = "*";

            StringList rnBusSelect = new StringList();
            StringList rnRelSelect = new StringList();
            String relAttributeParallel = "attribute[" + DomainObject.ATTRIBUTE_PARALLEL_NODE_PROCESSION_RULE + "]";
            rnRelSelect.add(relAttributeParallel);

            String strRelWhereRouteNode = "attribute[" + DomainObject.ATTRIBUTE_ROUTE_SEQUENCE + "]=='"+strRouteSequence+"'";

            String strObjectWhereRoute = "";

            MapList RouteNodes = route.getRelatedObjects(context, strRelPatternRouteNode, strTypePatternRoute, rnBusSelect, rnRelSelect, !GET_TO, GET_FROM, nRecurseToLevel, strObjectWhereRoute, strRelWhereRouteNode);
            Map routeNodesInfo = null;
            String parallelNode = "";
            for(Iterator itrRouteNodes = RouteNodes.iterator(); itrRouteNodes.hasNext();){
                routeNodesInfo = (Map)itrRouteNodes.next();
                parallelNode = (String)routeNodesInfo.get(relAttributeParallel);
                if(UIUtil.isNotNullAndNotEmpty(parallelNode)) {
                        break;
                }
            }
            mapRelRouteNodeAttributes.put(DomainObject.ATTRIBUTE_PARALLEL_NODE_PROCESSION_RULE,parallelNode);
            // End //
            ...
            if ("Started".equals(strRouteStatus)) {
                ...
                route.updateRouteActivityStatus(context, strRouteId);
            }
            else if ("Stopped".equals(strRouteStatus)) {
                //Starting the task at current level
    ...
    public  String createRouteFromTemplateForCA(Context context, String[] args) throws Exception {
    	HashMap params = (HashMap) JPO.unpackArgs(args);
    	String strObjectId = (String) params.get("contextObjectId");
    	String strState = (String) params.get("contextObjectStateName");
    	String strRouteTemplateId = (String) params.get("routeTemplateId");
    	String isTrue = (String) params.get("isTrue");
    	String routeCompletionAction = (String) params.get("routeCompletionAction");
    	String contextProject = (String) params.get("contextProject");
    	String contextOrg = (String) params.get("contextOrg");
    	Map objectRouteRelAttributes = (Map) params.get("objectRouteRelAttributes"); 
    	return addApproverTaskFromTemplate(context, strObjectId, strState, strRouteTemplateId, true,Boolean.parseBoolean(isTrue),routeCompletionAction,contextProject,contextOrg,objectRouteRelAttributes);
    }
     ...
     * @throws Exception
     */
    public  String createRouteFromTemplate(Context context, String[] args) throws Exception {
            String strObjectId          = args[0]; //object id
            String strState             = args[1]; //state name
            String strRouteTemplateId   = args[2]; //route template id
            if(args.length == 7) {
            	return addApproverTaskFromTemplate(context, strObjectId, strState, strRouteTemplateId, true,Boolean.parseBoolean(args[3]),args[4],args[5],args[6]);
            }else if (args.length == 4) {
            	return addApproverTaskFromTemplate(context, strObjectId, strState, strRouteTemplateId, true,Boolean.parseBoolean(args[3]));
            } else {
         return addApproverTaskFromTemplate(context, strObjectId, strState, strRouteTemplateId, true);
            }
     ...
     * @throws Exception
     */
    public String addApproverTaskFromTemplate(Context context, String[] args) throws Exception {
            String strObjectId          = args[0]; //object id
            String strState             = args[1]; //state name
            String strRouteTemplateId   = args[2]; //route template id
         return addApproverTaskFromTemplate(context, strObjectId, strState, strRouteTemplateId, false);
    }

    public  String addApproverTaskFromTemplate(Context context, String contextObjectId, String contextObjectState, String routeTemplateId, boolean forceTemplate) throws Exception {
    	return addApproverTaskFromTemplate( context,  contextObjectId,  contextObjectState,  routeTemplateId,  forceTemplate, false);
    }
    public  String addApproverTaskFromTemplate(Context context, String contextObjectId, String contextObjectState, String routeTemplateId, boolean forceTemplate,boolean sendMail) throws Exception {
    	return addApproverTaskFromTemplate( context,  contextObjectId,  contextObjectState,  routeTemplateId,  forceTemplate, sendMail,null,null,null);
    }
    public  String addApproverTaskFromTemplate(Context context, String contextObjectId, String contextObjectState, String routeTemplateId, boolean forceTemplate,boolean sendMail, String routeCompletionAction,String contextProject, String contextOrg) throws Exception {
    	return addApproverTaskFromTemplate( context,  contextObjectId,  contextObjectState,  routeTemplateId,  forceTemplate, sendMail,  routeCompletionAction, contextProject,  contextOrg, null);
     ...
     * @throws Exception
     */
    public  String addApproverTaskFromTemplate(Context context, String contextObjectId, String contextObjectState, String routeTemplateId, boolean forceTemplate,boolean sendMail, String routeCompletionAction,String contextProject, String contextOrg, Map objectRouteRelAttributes ) throws Exception {
        try {
            //int nReturnCode = 0;
            ContextUtil.startTransaction(context, true);
        	...
        	final String ATTRIBUTE_ROUTE_REQUIRES_ESIGN = PropertyUtil.getSchemaProperty(context, "attribute_RequiresESign");
        	final String SELECT_ATTRIBUTE_REQUIRES_ESIGN = "attribute[" + ATTRIBUTE_ROUTE_REQUIRES_ESIGN + "]";
            ...
            final String SELECT_ROUTE_CHOOSE_FROM_USERGROUP = DomainObject.getAttributeSelect(sAttrChooseUsersFromUserGroup);
            String sAttrrouteCompletionAction=PropertyUtil.getSchemaProperty(context, "attribute_RouteCompletionAction");
            final String SELECT_ROUTE_COMPLETION_ACTION = DomainObject.getAttributeSelect(sAttrrouteCompletionAction);
			...
			String sAttrsAttrRouteOwnerUGChoice = PropertyUtil.getSchemaProperty(context, "attribute_RouteOwnerUGChoice");
			final String SELECT_ROUTE_OWNER_UG_CHOICE = DomainObject.getAttributeSelect(sAttrsAttrRouteOwnerUGChoice);
...
//          For Bug 347000
			...
			String strCURRENT       = (String)mapObjectInfo.get(DomainObject.SELECT_CURRENT);
            String strParentObjectPolicy       = (String)mapObjectInfo.get(DomainObject.SELECT_POLICY);
            ...
            String RELATIONSHIP_INITIATING_ROUTE_TEMPLATE = PropertyUtil.getSchemaProperty(context, "relationship_InitiatingRouteTemplate");
            String groupType = PropertyUtil.getSchemaProperty(context,"type_Group");
            String proxyGoupType = PropertyUtil.getSchemaProperty(context,"type_GroupProxy");
            ...
            Route route = (Route)DomainObject.newInstance(context, DomainConstants.TYPE_ROUTE);
            String strRouteId = null;
			String strRoutePhysicalId = null;
            ...
            boolean routeNodeChooseUGFlag= false;
            ...
            slBusSelect = new StringList();
            slBusSelect.add(DomainObject.SELECT_ID);
			slBusSelect.add(DomainConstants.SELECT_PHYSICAL_ID);
            slBusSelect.add(SELECT_ROUTE_TASK_ASSIGNEE_TYPE);
            slBusSelect.add(SELECT_ATTRIBUTE_ROUTE_STATUS);
            slBusSelect.add(SELECT_ATTRIBUTE_CURRENT_ROUTE_NODE);
            slBusSelect.add(SELECT_ATTRIBUTE_ROUTE_TEMPLATE_TASK_EDIT_SETTING);
            ...
            String strRouteWhere = "current != Complete && current != Archive";
            if( forceTemplate ) {
            ...
            selects.add(SELECT_ATTRIBUTE_REQUIRES_ESIGN);
            ...
            selects.add(SELECT_ROUTE_CHOOSE_FROM_USERGROUP);
            selects.add(SELECT_ROUTE_COMPLETION_ACTION);
            ...
            String rTemplateRequiresESign = (String)routeTemplateMap.get(SELECT_ATTRIBUTE_REQUIRES_ESIGN);
            ...
            //getting attribute from RT
            String sRouteChooseUserGroup = (String)routeTemplateMap.get(SELECT_ROUTE_CHOOSE_FROM_USERGROUP);
            
            String routeCompletionActionOnRT = (String)routeTemplateMap.get(SELECT_ROUTE_COMPLETION_ACTION);
            if(UIUtil.isNullOrEmpty(routeCompletionAction)) {
            	routeCompletionAction = routeCompletionActionOnRT;
            }
            //End
        	String routeRequiresESign="False";
			String esignConfigSetting ="None";
        	 if(sRouteBasePurpose != null&&("Approval".equalsIgnoreCase(sRouteBasePurpose)||"Standard".equalsIgnoreCase(sRouteBasePurpose)))
        			 {
            ...
            if (mlRoutes.size() == 0 || "True".equalsIgnoreCase(sRouteChooseUserGroup)) {
                //Create new Route
                Person objPerson = Person.getPerson(context);
				...
				strRoutePhysicalId = FrameworkUtil.getPIDfromOID(context, strRouteId);
                ...
                for (Iterator itrTasks = mlTasks.iterator(); itrTasks.hasNext();) {
                 ...
                 // Copy all the attributes from route template Route Node relationship to Route
                    ...
                    String routeOwnerChoice = (String)mapRelAttributesToSet.get(sAttrRouteOwnerTask);
                    ...
                    if((DomainObject.TYPE_ROUTE_TASK_USER).equals(strUserType)){
                    	...
                    	if("TRUE".equalsIgnoreCase(routeOwnerChoice)) {
    						toObject = new DomainObject(PersonUtil.getPersonObjectID(context, context.getUser()));
    					}else {
                        //Normal task
                    ...
                    routeNodeChooseUG = (String)mapRelAttributesToSet.get(sAttrChooseUsersFromUserGroup);
                    
                    //checking if attribute is true for RouteNode
                    if(!routeNodeChooseUGFlag){
                    if("True".equalsIgnoreCase(routeNodeChooseUG)){
                    	routeNodeChooseUGFlag=true;
                    }
                    }
                ...
                selectList.add(DomainObject.SELECT_KINDOF_PLMENTITY);
                Map parentInfo = domainObject.getInfo(context, selectList);
                String strCurrentStateOfObject = (String)parentInfo.get(DomainObject.SELECT_CURRENT);
                ...
                try {
                    ...
                    String ATTRIBUTE_ROUTE_BASE_STATE = PropertyUtil.getSchemaProperty("attribute_RouteBaseState");
			          String strPolicyName = (String)parentInfo.get(DomainObject.SELECT_POLICY);
			          String strTypeName = (String)parentInfo.get(DomainObject.SELECT_TYPE);
			          String isPLMEntity = (String)parentInfo.get(DomainObject.SELECT_KINDOF_PLMENTITY);
					...
					if("true".equalsIgnoreCase(hasPromoteAccess) && Route.isStateBlockingAllowed(context, strTypeName) && !"true".equalsIgnoreCase(isPLMEntity)){						  
					     ...
					     if(objectRouteRelAttributes != null && !objectRouteRelAttributes.isEmpty() && objectRouteRelAttributes.containsKey(DomainConstants.ATTRIBUTE_MODELER_TYPE)) {
					    	 Route.addInterface(context,DomainConstants.INTERFACE_ROUTE_IDENTIFIER, objectRouteRelAttributes,  dmoRelationship.getPhysicalId(context));
					     }
                	if(UIUtil.isNotNullAndNotEmpty(contextOrg) && UIUtil.isNotNullAndNotEmpty(contextProject)) {
                		MqlUtil.mqlCommand(context, "trigger off", true);
                		String command = "mod bus $1 organization $2 project $3";
                		MqlUtil.mqlCommand(context, command, strRouteId, contextOrg, contextProject);
                	}
				     }
                finally {
                ...
                Map<String, String> routeAttributeMap = new HashMap<>();
                routeAttributeMap.put( ATTRIBUTE_AUTO_STOP_ON_REJECTION, sAutoStopOnRejection);
                routeAttributeMap.put( ATTRIBUTE_ROUTE_BASE_PURPOSE, sRouteBasePurpose);
                routeAttributeMap.put( ATTRIBUTE_ROUTE_REQUIRES_ESIGN, routeRequiresESign);
                routeAttributeMap.put( sAttrRestrictMembers, sRouteScope);
                routeAttributeMap.put( sAttrRoutePreserveTaskOwner, sRoutePreserveTask);
                routeAttributeMap.put( ATTRIBUTE_CURRENT_ROUTE_NODE, "1");
                routeAttributeMap.put( DomainObject.ATTRIBUTE_TITLE, strRouteName);
                
                if(UIUtil.isNotNullAndNotEmpty(routeCompletionAction)) {
                	routeAttributeMap.put( sAttrrouteCompletionAction, routeCompletionAction);
                }
                
                route.setAttributeValues(context, routeAttributeMap);
               ...
               if (mlRoutes.size() == 0){
                   ...
                   return null;
                    ...
                    String intiatingRouteTaskEditSetting = (String)mapRouteToBeUsed.get(SELECT_ATTRIBUTE_ROUTE_TEMPLATE_TASK_EDIT_SETTING);
                    String routeTaskEditSetting = (String)mapRouteToBeUsed.get("attribute[" + DomainConstants.ATTRIBUTE_TASKEDIT_SETTING + "]");
                    if("Maintain Exact Task List".equals(intiatingRouteTaskEditSetting)){
                    	String taskAddApproverAlert = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource",  context.getLocale(), "emxComponents.RouteWizard.MaintainExactTaskListTaskAddAlert");
                    	throw new MatrixException(taskAddApproverAlert);
                    }
                    
                    if(UIUtil.isNullOrEmpty(intiatingRouteTaskEditSetting) && "Maintain Exact Task List".equals(routeTaskEditSetting)) {
                    	String taskAddApproverAlert = EnoviaResourceBundle.getProperty(context, "emxComponentsStringResource",  context.getLocale(), "emxComponents.Route.MaintainExactTaskListTaskAddAlert");
                    	throw new MatrixException(taskAddApproverAlert);
                    }
                    ...
                    strRouteId  = (String)mapRouteToBeUsed.get(DomainObject.SELECT_ID);
					strRoutePhysicalId  = (String)mapRouteToBeUsed.get(DomainConstants.SELECT_PHYSICAL_ID);
                    route       = new Route(strRouteId);
            ...
            for (Iterator itrRouteNodeRelInfo = mlRouteNodeRelInfo.iterator(); itrRouteNodeRelInfo.hasNext();) {
				...
				strRouteNodeRelId = MqlUtil.mqlCommand(context, "print connection $1 select $2 dump", strRouteNodeRelId, DomainConstants.SELECT_PHYSICAL_ID);
            ...
            if(routeNodeChooseUGFlag && strCURRENT.equals(contextObjectState)){
            	MailUtil.sendNotificationWhenObjectBlockedFromPromoting(context,strRouteId,sendMail);
            }
    ...
    public int removeApproverTask(Context context, String[] args) throws Exception {
        try {
            ...
            final String SELECT_CURRENT_ROUTE_NODE = ATTRIBUTE_OPEN_BRACE + sAttCurrentRouteNode + "]";
            final String SELECT_ROUTE_SEQUENCE = ATTRIBUTE_OPEN_BRACE + DomainObject.ATTRIBUTE_ROUTE_SEQUENCE + "]";
            final String SELECT_ROUTE_NODE_ID = ATTRIBUTE_OPEN_BRACE + DomainObject.ATTRIBUTE_ROUTE_NODE_ID + "]";
    		final String SELECT_ATTRIBUTE_TITLE = ATTRIBUTE_OPEN_BRACE + DomainConstants.ATTRIBUTE_TITLE+ "]";
            ...
            if (isBusinessObject) {
                ...
                slBusSelect.add("from[" + DomainObject.RELATIONSHIP_ROUTE_TASK + "].to.attribute[" + DomainConstants.ATTRIBUTE_TASKEDIT_SETTING + "]");
                slBusSelect.add("from["+DomainConstants.RELATIONSHIP_ROUTE_TASK+"].to.owner");
				slBusSelect.add("type.kindof["+DomainConstants.TYPE_INBOX_TASK+"]");
                ...
                String strRouteTaskEditSetting = (String)mapInfo.get("from[" + DomainObject.RELATIONSHIP_ROUTE_TASK + "].to.attribute[" + DomainConstants.ATTRIBUTE_TASKEDIT_SETTING + "]");
                String routeOwner = (String)mapInfo.get("from["+DomainConstants.RELATIONSHIP_ROUTE_TASK+"].to.owner");
				String isKindOfTask = (String)mapInfo.get("type.kindof["+DomainConstants.TYPE_INBOX_TASK+"]");
				if("true".equalsIgnoreCase(isKindOfTask)){
					throw new MatrixException(EnoviaResourceBundle.getProperty(context,"emxComponentsStringResource",context.getLocale(),"emxComponents.InboxTask.CannotDeleteAssignedTask"));
				}
                ...
                if(UIUtil.isNullOrEmpty(strEditSetting) && "Maintain Exact Task List".equalsIgnoreCase(strRouteTaskEditSetting)){
					String taskRemoveAlert = EnoviaResourceBundle.getProperty(context,"emxComponentsStringResource",context.getLocale(),"emxComponents.Route.MaintainExactTaskListTaskRemoveAlert");
					throw new MatrixException(taskRemoveAlert);
                }
                ...
                if(routeOwner.equals(context.getUser())){
                // Delete task
                ...
                DomainRelationship.disconnect(context, strRouteNodeId);
            		...
            		String message = EnoviaResourceBundle.getProperty(context,"emxComponentsStringResource",context.getLocale(),"emxComponents.DeleteRoute.LifecycleTaskRemoveAlert");
                ...
                relationshipSelects.add("from.attribute[" + DomainConstants.ATTRIBUTE_TASKEDIT_SETTING + "]");
                ...
                String strRouteTaskEditSetting = (String)mapInfo.get("from.attribute[" + DomainConstants.ATTRIBUTE_TASKEDIT_SETTING + "]");
                if("Maintain Exact Task List".equalsIgnoreCase(strEditSetting)){
 					String taskRemoveAlert = EnoviaResourceBundle.getProperty(context,"emxComponentsStringResource",context.getLocale(),"emxComponents.RouteWizard.MaintainExactTaskListTaskRemoveAlert");
					throw new MatrixException(taskRemoveAlert);
                }
                ...
                MapList mlTasks = dmoRouteObject.getRelatedObjects(context, 
                                                                    ...
                                                                    !GET_FROM, 
                                                                    nRecurseToLevel,
                                                                    ATTRIBUTE_OPEN_BRACE + DomainObject.ATTRIBUTE_ROUTE_NODE_ID + "]=='" + strRouteNodeId + "'",
                                                                    "");
                // Delete tasks
            ...
            if (strRouteId != null){
                ...
                if(mlRouteNodes.size() != 0){
                    ...
                    if(mlDefinedTasksOnRoute.isEmpty()){
                    	if(UIUtil.isNullOrEmpty(strCurrentRouteLevel)){
                    		strCurrentRouteLevel = "1";
                    	}else {
                    	strCurrentRouteLevel = Integer.toString(Integer.parseInt(strCurrentRouteLevel)+1);
                    }
...
//          End : Bug 346997 code modification
            ...
            strTreeLink.append("<img border=\"0\" src=\"images/iconSmallTask16.png\">${NAME}</a>");
            ...
            strTaskPropertiesLink.append("<img border=\"0\" src=\"images/iconSmallTask16.png\">${NAME}</a>");
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                strInfoType = (String)mapObjectInfo.get("infoType");
				strObjectPolicy = (String)mapObjectInfo.get("objectPolicy");
				String updatedStrObjectPolicy = "";
				if(UIUtil.isNotNullAndNotEmpty(strObjectPolicy)){
					updatedStrObjectPolicy= strObjectPolicy.replace(' ', '_');
				}
...
//              Begin : Bug 346997 code modification
                if (isExporting) {
                    if (INFO_TYPE_SIGNATURE.equals(strInfoType)) {
						...
						if((returnString.indexOf("emxFramework.Lifecycle.")!= -1) || UIUtil.isNullOrEmpty(returnString) ) {
							i18NString= "emxFramework.State."+updatedStrObjectPolicy+"."+updatedStrName;
							returnString = EnoviaResourceBundle.getProperty(context,"emxFrameworkStringResource",strLocale, i18NString);
							if((returnString.indexOf("emxFramework.State.")!= -1) || UIUtil.isNullOrEmpty(returnString)) {
                               strHTMLBuffer.append(strName);  
							}else{
...
//              End : Bug 346997 code modification
    ...
    public  Vector getApproverForTaskSignatures(Context context, String[] args) throws Exception {
        try {
            ...
            final String STRING_USERGROUP = EnoviaResourceBundle.getProperty(context,"emxFrameworkStringResource",new Locale(strLanguage), "emxFramework.Type.Group");
            String groupType = PropertyUtil.getSchemaProperty(context,"type_Group");
            String proxyGoupType = PropertyUtil.getSchemaProperty(context,"type_GroupProxy");
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                if (INFO_TYPE_ACTIVATED_TASK.equals(strInfoType) || INFO_TYPE_DEFINED_TASK.equals(strInfoType)) {
                    ...
                    else if(groupType.equals((String)mapObjectInfo.get("assigneeType")) || proxyGoupType.equals((String)mapObjectInfo.get("assigneeType"))){
                    	String assigneeName = (String)mapObjectInfo.get("assigneeName");
                    	assigneeName = assigneeName + "( " + STRING_USERGROUP + " )";
                    	vecResult.add(assigneeName);
                    }
                    else {
                    ...
                    if ("true".equalsIgnoreCase((String)mapObjectInfo.get("signed"))) {
                        ...
                        for (Iterator itrApprovers = slApprovers.iterator(); itrApprovers.hasNext();) {
                            ...
                            //  //Check if its Role
                            try {
                            	if(FrameworkUtil.isUserGroupObject(context, strRoleOrGroup)){
                            		 strRoleOrGroup = strRoleOrGroup + "(" + STRING_USERGROUP + ")";
                                     slTranslatedApprovers.add(strRoleOrGroup);
                            	}else if(isRoleOrGroup(context,"Role",strRoleOrGroup)){
                                    roleObj = new Role(strRoleOrGroup);
                                    roleObj.open(context);
...
//          End : Bug 346997 code modification
            ...
            final String STRING_AWAITING_REVIEW = (String)loc.GetString(RESOURCE_BUNDLE, strLanguage, "emxFramework.Lifecycle.NeedsReview");
			...
			final String STRING_ROUTENODE_DRAFT =  EnoviaResourceBundle.getFrameworkStringResourceProperty(context,"emxFramework.LifecycleRouteNode.Draft",context.getLocale());
           ...
           /* String sTaskApproveURL = "'../common/emxLifecycleApproveRejectPreProcess.jsp'";
            String sTaskApproveParameters = "'emxTableRowId=${EMXFLATTABLEROWID}&objectId=${OBJECT_ID}&suiteKey=Framework&jsTreeId="+XSSUtil.encodeForJavaScript(context, jsTreeID)+" '";
			...
			//checking the person assignments to know if the person is member of any user group which is a task assignee
            ...
            String sTaskAction  = null;

            // Do for each object
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
				strTaskApproveLink = new StringBuffer(64);
                mapObjectInfo = (Map) itrObjects.next();
			
				sTaskAction  = (String)mapObjectInfo.get("routeAction");
                strInfoType = (String)mapObjectInfo.get("infoType");
                ...
                emxFlatTableRowId = (String)mapObjectInfo.get("emxFlatTableRowId");
                ...
                if (INFO_TYPE_SIGNATURE.equals(strInfoType)) {
                    ...
                    //START BUG 346838
                        ...
                        vecResult.add(STRING_AWAITING_REVIEW);
                        //END BUG 346838
                    }
                    else {
                        ...
                        if ("Stopped".equals(strCurrentRouteStatus)) {
                            ...
                            strAssigneeGroupName = (String)mapObjectInfo.get("assigneeUserGroupName");
...
//                              Begin : Bug 346997 code modification
                                if (isExporting) {
									if(UIUtil.isNotNullAndNotEmpty(sTaskAction) && "Comment".equalsIgnoreCase(sTaskAction)) {
										 vecResult.add(STRING_AWAITING_COMMENT);
									...
									strTaskApproveLink.append("<a href=\"javascript:submitWithCSRF("+sTaskApproveURL+", findFrame(getTopWindow(),'listHidden'),"+sTaskApproveParameters+");\">");
									if(UIUtil.isNotNullAndNotEmpty(sTaskAction) && "Comment".equalsIgnoreCase(sTaskAction)) {
										 strTaskApproveLink.append(STRING_AWAITING_COMMENT);
									}else  if(UIUtil.isNotNullAndNotEmpty(sTaskAction) && "Approve".equalsIgnoreCase(sTaskAction)) {
										 strTaskApproveLink.append(STRING_AWAITING_APPROVAL);
									}
									strTaskApproveLink.append("</a>");
                                String strFormattedLink = FrameworkUtil.findAndReplace(strTaskApproveLink.toString(), "${EMXFLATTABLEROWID}", emxFlatTableRowId);
                                strFormattedLink = FrameworkUtil.findAndReplace(strFormattedLink.toString(), "${OBJECT_ID}", strParentObjectId);
...
//                              End : Bug 346997 code modification
                                ...
                                if (strRouteTaskUser == null || "".equals(strRouteTaskUser)) {
                                	if(("Group".equals(strassigneeType) || "Group Proxy".equals(strassigneeType)) && UIUtil.isNotNullAndNotEmpty(strAssigneeGroupName) &&
                                			userGroupList.contains(strAssigneeGroupName)){
...
//                                      End : Bug 346997 code modification
                    ...
                    if ("Started".equals(strCurrentRouteStatus)) {
                        ...
                        vecResult.add(STRING_ROUTENODE_DRAFT);
                    }
                }
                else {
                    throw new Exception(ComponentsUtil.i18nStringNow("emxComponents.LifeCycle.InvalidTypeOfTaskObject", context.getLocale().getLanguage()));
...
//                  End : Bug 346997 code modification
        ...
        try {
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                if (!"true".equalsIgnoreCase((String)mapObjectInfo.get("fromApproveAssignedTasks"))) {
                    ...
                    finalURL.append("<img border=\"0\" src=\"images/iconSmallTask16.png\">");
    ...
    public  Vector getApprovalStatusForMassTasksApproval(Context context, String[] args) throws Exception {
        ...
        try {
			...
			String isIgnoreTaskRejectComments = EnoviaResourceBundle.getProperty(context, "emxComponentsRoutes.InboxTask.IgnoreComments");
            ...
            boolean showAbstain = "true".equalsIgnoreCase(FrameworkUtil.getshowAbstainOptionValue(context));
            if(showAbstain) 
            {
                //审批时候，下拉式菜单中有一项为“放弃”，这个选项隐藏掉 by cyl 20250827
...
//                                 "</option>";
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext(); ) {
                mapObjectInfo = (Map) itrObjects.next();
			    sTaskAction  = (String)mapObjectInfo.get(DomainObject.ATTRIBUTE_ROUTE_ACTION);
                ...
                if(isTaskApprovalCommentsOn.equals("false") || "true".equalsIgnoreCase(isIgnoreTaskRejectComments)){
    ...
    public  Vector getCommentsForMassTasksApproval(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext(); ) {
                ...
                strSerialNumber = (String)mapObjectInfo.get("serialNumber");
				String routeAction = (String)mapObjectInfo.get(SELECT_ATTRIBUTE_ROUTE_ACTION);
                comment = mapObjectInfo.get(SELECT_ATTRIBUTE_COMMENTS) != null ? (String)mapObjectInfo.get(SELECT_ATTRIBUTE_COMMENTS) : "";
                //
                // Form the text area for comments
                //
                try {
                	if(comment!=null && (comment.contains("<a") || comment.contains("&lt;") ||comment.contains("&gt;"))) {
                    	comment=emxInboxTaskBase_mxJPO.getTextFromHTML(comment);
                    }
				} catch (Exception e) {
				}
                strHTML = new StringBuffer(64);
                strHTML.append("<textarea rows=\"5\" name=\"Comments").append(XSSUtil.encodeForHTMLAttribute(context, strSerialNumber))
                .append("\" id=\"Comments").append(XSSUtil.encodeForHTMLAttribute(context, strSerialNumber))
                .append("Id\"");
				if("Approve".equals(routeAction) && "false".equals(isTaskApprovalCommentsOn)){
					strHTML.append(" disabled ");
				}
				strHTML.append(">").append(XSSUtil.encodeForHTML(context, comment)).append("</textarea>");
    ...
    public  Vector getCheckboxForApprovals(Context context, String[] args) throws Exception {
        try {
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                strAssigneeType = (String)mapObjectInfo.get("assigneeType");
                strInfoType = (String)mapObjectInfo.get("infoType");
				strTemplateTaskSetting = (String)mapObjectInfo.get("sTaskEditSetting");
				String templateTask = (String)mapObjectInfo.get("templateTask");
				isTemplateTask = "Yes".equalsIgnoreCase(templateTask);
				if(UIUtil.isNullOrEmpty(strTemplateTaskSetting)) {
					strTemplateTaskSetting =  (String)mapObjectInfo.get("sRouteEditSetting");
					isTemplateTask = "Yes".equalsIgnoreCase((String)mapObjectInfo.get("initialTask"));
				}
                ...
                if (PolicyUtil.checkState(context, strParentObjId, strParentObjectState, PolicyUtil.GT)) {
                    ...
                    if (INFO_TYPE_SIGNATURE.equals(strInfoType)) {
					...
					else if(!"Modify/Delete Task List".equals(strTemplateTaskSetting) && isTemplateTask){
                            vecResult.add(String.valueOf(!ENABLECHECKBOX));
                        }
                    else if (INFO_TYPE_ACTIVATED_TASK.equals(strInfoType)) {
                    	if (!POLICY_INBOX_TASK_STATE_ASSIGNED.equals(strCurrentState)) {
							...
							// Tasks to be accepted (assigned to role or group)
							// cannot be selected
...
//          End : Bug 346997 code modification
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                if (isAdHoc) {
                	...
                	strParentObjectTranslatedState = EnoviaResourceBundle.getStateI18NString(context, strParentObjectPolicy, strParentObjectState, strLanguage);
...
//          End : Bug 346997 code modification
            ...
            strTreeLinkForPerson.append("<img border=\"0\" src=\"images/iconSmallPerson.png\">${NAME}</a>");
            String strUserGroup = EnoviaResourceBundle.getProperty(context,"emxFrameworkStringResource",new Locale(strLanguage), "emxFramework.Type.Group");
            // Do for each object
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                Map mapObjectInfo = (Map) itrObjects.next();
                strInfoType = (String)mapObjectInfo.get("infoType");
                ...
                if (INFO_TYPE_ACTIVATED_TASK.equals(strInfoType) || INFO_TYPE_DEFINED_TASK.equals(strInfoType)) {
                    ...
                    // Decide the name of the approver
                	String assigneeType = (String)mapObjectInfo.get("assigneeType");
                    if (DomainObject.TYPE_ROUTE_TASK_USER.equals(assigneeType)) {
                        // If the type of the assignee is RTU then get the name of the role/group as approver name
                        String strRouteTaskUser = (String)mapObjectInfo.get("routeTaskUser");
                        if (strRouteTaskUser == null || "".equals(strRouteTaskUser.trim()) || "null".equals(strRouteTaskUser)) {
                            vecResult.add(strHTMLBuffer.toString());
...
//                             End : Bug 346997 code modification
                    ...
                    }else if (groupType.equals(assigneeType) || proxyGoupType.equals(assigneeType) ){
                		if (isExporting) {
                             vecResult.add((String)mapObjectInfo.get("assigneeName") + "("+strUserGroup+")");
                        }else {
                            strHTMLBuffer.append("<img src=\"images/iconSmallGroup.gif\" border=\"0\" align=\"left\">");
                            strHTMLBuffer.append(XSSUtil.encodeForHTML(context, (String)mapObjectInfo.get("assigneeName")+"("+strUserGroup+")"));
                            vecResult.add(strHTMLBuffer.toString());
                    }
                    }else {
                        // If the type of the assignee is not RTU then it is person and get the name of the person as approver name
...
//                      Begin : Bug 346997 code modification
                        if (isExporting) {
                            strHTMLBuffer = new StringBuffer( strName);
                        }
                        else {
                        strHTMLBuffer = new StringBuffer (FrameworkUtil.findAndReplace(strTreeLink.toString(), "${OBJECT_ID}", strObjectId));
                        strHTMLBuffer = new StringBuffer (FrameworkUtil.findAndReplace(strHTMLBuffer.toString(), "${NAME}", strName));
...
//                     End : Bug 346997 code modification
    ...
    public  Vector getActionForApprovals(Context context, String[] args) throws Exception {
        try {
            ...
            final String STRING_PENDING = (String)loc.GetString(RESOURCE_BUNDLE, strLanguage, "emxFramework.LifecycleRouteNode.Draft");
            final String STRING_PENDING_ORDER = (String)loc.GetString(RESOURCE_BUNDLE, strLanguage, "emxFramework.LifecycleTasks.PendingOrder");
            final String STRING_APPROVE = (String)loc.GetString(RESOURCE_BUNDLE, strLanguage, "emxFramework.Lifecycle.Approve");
		   ...
		   final String STRING_NOTIFICATION_SENT =  EnoviaResourceBundle.getFrameworkStringResourceProperty(context,"emxFramework.LifecycleTasks.NotificationSent",context.getLocale());          
            ...
            for (Iterator itrObjects = objectList.iterator(); itrObjects.hasNext();) {
                ...
                strRouteNodeId = (String)mapObjectInfo.get("routeNodeId");
                strApprovalStatus = (String)mapObjectInfo.get("approvalStatus");
				strRouteAssigne = (String)mapObjectInfo.get("assigneeName");
				strRouteOwner = (String)mapObjectInfo.get("owner");
                ...
                if (INFO_TYPE_SIGNATURE.equals(strInfoType)) {
                    ...
                    if ("true".equalsIgnoreCase((String)mapObjectInfo.get("signed"))) {
                        if ("true".equalsIgnoreCase((String)mapObjectInfo.get("approved"))) {
							...
							if(strRouteOwner.equals(strRouteAssigne)){
    ...
    public boolean isRoleOrGroup(Context context,String roleOrGroupName, String sSignName) throws MatrixException {
        
        String strCommand = "list $1 $2";
        MQLCommand command = new MQLCommand();
        command.executeCommand(context, strCommand, roleOrGroupName, sSignName);
   ...
   /**
     ...
     */
	  ...
	  public void createNewRoute(Context context,String strRouteId,Route route,String strParentObjId,String strParentObjectState )throws Exception{
        ...
        //Set Requires ESign attribute on route
    	...
    	Map<String, String> routeAttributeMap = new HashMap<>();
    	routeAttributeMap.put( ATTRIBUTE_REQUIRES_ESIGN, routeRequiresESign);
    	routeAttributeMap.put( DomainConstants.ATTRIBUTE_TITLE, strRouteName);
    	route.setAttributeValues(context, routeAttributeMap);
        //
